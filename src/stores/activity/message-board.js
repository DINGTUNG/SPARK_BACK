...
export const useMessageBoardStore = defineStore('message-board', () => {
  ...
  function deleteMessageBackend(messageNo) {
    ...
    const request = {
      method: "POST",
      url: `https://tibamef2e.com/chd102/g3/back-end/php/activity/message-board/delete_message.php`,
      headers: {
  ...
  function updateMessageBackend(messageNo,sparkActivityId,messageContent,memberId) {
    ...
    const request = {
      method: "POST",
      url: `https://tibamef2e.com/chd102/g3/back-end/php/activity/message-board/update_message.php`,
      headers: {
        "Content-Type": "multipart/form-data",
      },
      data: payLoad,
