...
const reportForCreate = reactive({
  reportNo: null,
  reportClass: "",
  reportTitle: "",
  reportYear: "",
...
async function createReport(reportForCreate) {
  try {
    const newReport = await reportStore.createReportBackend(reportForCreate)
        ...
        <form action="http://localhost/SPARK_BACK/php/results/report/create_report.php" method="post" @submit.prevent="
          ...
          <v-card-text>
            <div class="form_item">
              ...
              <input type="text" id="class" name="report_class" v-model="reportForCreate.reportClass">
            </div>
            <div class="form_item">
              <div class="name"><span>年度</span></div>
              <input type="text" id="year" name="report_year" v-model="reportForCreate.reportYear">
            </div>
            <div class="form_item">
              <div class="name"><span>標題</span></div>
              <input type="text" id="title" name="report_title" v-model="reportForCreate.reportTitle">
            </div>
            <div class="imgblock form_item">
              <div class="name"><span>報告</span></div>
              <v-file-input id="file" prepend-icon="none" name="report_file_path" v-model="reportForCreate.reportFile">
