...
CREATE TABLE IF NOT EXISTS `dream_star` (
  ...
  `dream_star_image` varchar(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `is_news_online` tinyint DEFAULT NULL COMMENT '0:下線 1:上線',
  `register` varchar(20) NOT NULL DEFAULT '星火大老闆',
  `regist_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(20) NOT NULL DEFAULT '星火大老闆',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `reports_file_path` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `reports_image` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
(4, 'R004', 0, '年度', '星火執行業務報告', '2021', '\"R2021_ business_rep', '\"R2021_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(5, 'R005', 0, '年度', '星火執行業務報告', '2022', '\"R2022_ business_rep', '\"R2022_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(6, 'R006', 0, '年度', '星火執行業務報告', '2023', '\"R2023_ business_rep', '\"R2023_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(7, 'R007', 0, '財務', '星火執行財務報告', '2018', '\"R2018_ business_rep', '\"R2018_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(8, 'R008', 0, '財務', '星火執行財務報告', '2019', '\"R2019_ business_rep', '\"R2019_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(9, 'R009', 0, '財務', '星火執行財務報告', '2020', '\"R2020_ business_rep', '\"R2020_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(10, 'R010', 0, '財務', '星火執行財務報告', '2021', '\"R2021_ business_rep', '\"R2021_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(11, 'R011', 0, '財務', '星火執行財務報告', '2022', '\"R2022_ business_rep', '\"R2022_ business_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00'),
(12, 'R012', 0, '財務', '星火執行財務報告', '2023', '\"R2023_  finance_rep', '\"R2023_  finance_rep', 1, '星火大老闆', '2023-08-01 19:26:00', '星火大老闆', '2023-08-01 19:26:00');
...
CREATE TABLE IF NOT EXISTS `spark_activity` (
  ...
  `spark_activity_start_date` char(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `spark_activity_end_date` char(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `is_online` tinyint DEFAULT NULL COMMENT '0:下線 1:上線',
  `register` varchar(20) NOT NULL DEFAULT '星火大老闆',
  `regist_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(20) NOT NULL DEFAULT '星火大老闆',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(7, 'ST007', 0, '萌萌的鐵道世界', '2023-06-09', 'story_7.png', '每當萌萌走進鐵道世界，他的眼睛就會閃耀著興奮的光芒。他會花上整個下午建設火車軌道、設置小火車......', '萌萌眼中燃燒著興奮的火焰，他手中握著一個精緻的小火車玩具。他將它輕輕放在軌道上，火車蜿蜒前進，發出嗡嗡的聲音。小明的臉上洋溢著快樂的笑容，他與小火車一同探索著無限的遊戲世界。', '火車沿著彎曲的軌道穿梭，經過小山丘和橋樑。小明的想像力瞬間被點燃，他模擬火車經歷著驚險刺激的旅程，穿越山谷和越過障礙。他對小火車的每一次控制都充滿著自信和喜悅。', '小明邀請朋友們一同加入遊戲，他們圍坐在地上，用手與笑聲模擬著小火車的運行。他們合力建造軌道、設計站台，共同創造屬於他們的迷你鐵路世界。', 1, '星火大老闆', '2023-08-01 19:29:08', '星火大老闆', '2023-08-01 19:29:08'),
...
(9, 'ST009', 0, '我是這樣長大的', '2023-07-15', 'story_9.png', '小安從小就以她的畫筆將奇幻的夢境和美麗的色彩帶入現實生活，她用繽紛的色彩和獨特的構圖展現她對......', '小安手握著五彩的蠟筆，專注地在畫紙上揮灑著自己的想像。他畫出了一個夢幻的森林，樹上掛滿了燦爛的花朵，小動物們歡快地奔跑著。他的臉上洋溢著快樂的笑容，畫筆在他的指尖舞動著。', '小安展示著他的畫作，眾人驚嘆著他的藝術天賦。他的作品散發著童真和創意，彷彿一個個魔法的世界。朋友們圍繞著他，紛紛稱讚他的畫技和豐富的想像力。小明感受到他們的支持和鼓勵，更加自信地繼續創作著。', '畫筆在小明的手中成為一個無限的魔法工具，他通過每一幅畫作表達出自己的情感和世界觀。當他看著自己的作品時，他感到無比的快樂和成就。畫畫成為他忘卻壓力的途徑，也為他的童年增添了無盡的快樂和美好回憶。', 1, '星火大老闆', '2023-08-01 19:29:08', '星火大老闆', '2023-08-01 19:29:08'),
(10, 'ST010', 0, '小手揉麵 共享美味', '2023-07-20', 'story_10.png', '小朋友們認真地學習製作麵包，彼此合作搓揉麵團，一同創造出美味的麵食作品。他們用小手捏出有趣的......', '在星火兒童協會的廚房裡，一群充滿活力的小朋友圍坐在長桌旁，熱情地揉著麵團。他們的小手掌沾滿了麵粉，笑聲和歡樂彌漫在空氣中。協會的導師們帶領著他們，一同展開了一場美味的冒險。', '小朋友們充滿興奮地將麵團揉搓得越來越柔軟，他們一起分享著創意和技巧，塑造出各種有趣的形狀，如動物、星星和花朵。他們彼此鼓勵，互相幫助，建立起了友誼的紐帶。', '經過烘焙，美味的麵食從烤箱中散發出迷人的香氣。小朋友們期待已久地坐在一起，品嚐他們共同製作的成果。眼神中充滿了驚喜和自豪，他們大快朵頤，享受著這份自己親手創造的美味。', 1, '星火大老闆', '2023-08-01 19:29:08', '星火大老闆', '2023-08-01 19:29:08');
